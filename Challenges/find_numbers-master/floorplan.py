...
class FloorPlan(ShowBase):
    ...
    # I don't know how I am supposed to export this to my repo.
    def __init__(self):
        super().__init__()
    ...
    def rotate_model(self, axis, direction):
        ...
        # if axis == 0:  # X-axis
        #     self.house.set_h(self.house.get_h() + self.rotation_speed * dt)
        # elif axis == 1:  # Y-axis
        #     self.house.set_p(self.house.get_p() + self.rotation_speed * dt)
        # elif axis == 2:  # Z-axis
        #     self.house.set_r(self.house.get_r() + self.rotation_speed * dt)
